...
| M4 Host capabilities | Notifications → freedesktop ✅ · Network → NetworkManager + host DNS ✅ · Storage → home dir ✅ (SAF picker pending intents) · Audio → PipeWire · Location → GeoClue · Intent dispatcher ✅ (explicit + implicit; deep-links/PendingIntent/SAF next) | 🚧 in progress |
